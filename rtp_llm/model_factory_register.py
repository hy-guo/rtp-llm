...
def _register_builtin_lazy_models() -> None:
    ...
    register_lazy_model(
        "deepseek_v4_dspark", "rtp_llm.models.deepseek_v4", ["DSparkDraftModel"]
    )
    register_lazy_model(
        "deepseek_vl_v2",
    ...
    register_lazy_model(
        "qwen4_exp",
        "rtp_llm.models.qwen4_exp.qwen4_exp",
    ...
    register_lazy_model(
        "qwen3_vl", "rtp_llm.models.qwen3_vl", ["Qwen3VLForConditionalGeneration"]
    )
    register_lazy_model(
        "qwen3_vl_moe",
    ...
    register_lazy_model("qwen_v2_audio", "rtp_llm.models.qwen_v2_audio")
    ...
    register_lazy_model(
        "kimi_k25",
        "rtp_llm.models.kimi_k25.kimi_k25",
